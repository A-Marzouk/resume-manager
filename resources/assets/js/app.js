...
if ($('#adminRegisterAgent').length !== 0) {
    ...
    const routes = [{
            ...
            component: AdminAgentRegisterPage1
        },
        {
            path: '/admin/register-agent/page1',
            component: AdminAgentRegisterPage1
        },
        {
            path: '/admin/register-agent/page2',
            component: AdminAgentRegisterPage2
        },
        {
            path: '/admin/register-agent/page3',
            component: AdminAgentRegisterPage3
        },
        {
            path: '/admin/register-agent/page4',
            component: AdminAgentRegisterPage4
        },
        {
            path: '/admin/register-agent/page5',
            component: AdminAgentRegisterPage5
        },
        {
            path: '/admin/register-agent/completed',
            component: AdminAgentRegisterCompleted
        }
    ];
...
if ($("#clientDashboardComponent").length !== 0) {
    ...
    const routes = [{
            path: '/client/dashboard/my-account',
            component: MyAccount
        },
        {
            path: '/client/dashboard/agents-database',
            component: AgentsDatabase
        },
        {
...
if ($('#freelancerRegisterComponent').length !== 0) {
    ...
    const routes = [{
            ...
            component: FreelancerRegisterPage1
        },
        {
            path: '/freelancer/register/page1',
            component: FreelancerRegisterPage1
        },
        {
            path: '/freelancer/register/page2',
            component: FreelancerRegisterPage2
        },
        {
            path: '/freelancer/register/page3',
            component: FreelancerRegisterPage3
        },
        {
            path: '/freelancer/register/page4',
            component: FreelancerRegisterPage4
        },
        {
            path: '/freelancer/register/page5',
            component: FreelancerRegisterPage5
        },
        {
            path: '/freelancer/register/completed',
            component: FreelancerRegisterCompleted
        }
    ];
...
if ($('#freelancerDashboardComponent').length !== 0) {
    const routes = [{
            path: '/freelancer/dashboard/my-account',
            component: FreelancerMyAccount
        },
        {
        ...
        },
        {
            ...
            component: FreelancerCampaignManager
        }
    ]
...
if ($('#freelancerCampaignMainComponent').length !== 0) {
    const routes = [{
            path: '/:campaign-team',
            component: FreelancerCampaignTeam
        },
        {
            path: '/:campaign-brief',
            component: FreelancerCampaignBrief
        },
        {
            path: '/',
            component: FreelancerCampaignActivity
        }
    ];
