  ...
  <div class="rootElement">
    ...
    <div class="monthsView"
      ...
      <div class="row">
        <div class="col-md-4"
             ...
             v-bind:key="index">
          <div class="monthBox">
            <button :disabled="getMonthBookings(index+1) == 0"
                    class="btn btn-outline-primary btn-block"
                    @click="filterBookingsByMonth(index+1)">
              {{month}}<br />
    ...
    <div class="daysView"
      ...
      <div class="row">
        <div class="col-md-2">
          Paid :
          <img src="/images/green_circle.png" alt="red" height="6" width="6">
                </div>
          <div class="col-md-6">
            Unpaid :
            <img src="/images/red_circle.png" alt="red" height="6" width="6">
                </div>
          </div>
          <div class="row">
            <div class="col-md-3"
              ...
              <div class="dayBox">
                <button class="btn btn-block btn-outline-dark"
                        :disabled="getDayBookings(index).length == 0">
                  {{index}}/{{month}}/{{year}} <br />
