<template>
  <div>
    <transition-group name="list"
                      class="row">
      <cbrief-component v-for="(cBrief,index) in cBriefs"
                        v-bind:key="index"
    ...
    height: 15px;">
        ...
        <div class="deleteWorkBtn NoDecor"
             @click="editCBrief(cBrief.id)"
             style="width: 169px;margin-right: 7px;">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div v-for="(service,index) in cBrief.services"
                 v-bind:key="index">
    ...
    <br />
    <add-cbrief-modal @cBriefAdded="addCBrief"
                      :toBeEditedCBrief="toBeEditedCBrief"></add-cbrief-modal>
