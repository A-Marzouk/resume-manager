        ...
        <div class="modal-content">
          ...
          <div class="modal-body"
            ...
            <transition-group name="list"
                              class="row"
                              v-show="this.toBeEditedCamp.members.length > 0">
              <div class="col-md-2 col-6 freelancerBox list-item"
                   v-for="(user,index) in toBeEditedCamp.members"
                   v-bind:key="index">
            ...
            <div v-show="this.toBeEditedCamp.members.length < 1"
                 class="pageSubHeading text-left">
            ...
            <transition-group name="list"
                              class="row">
              <div class="list-item col-md-2 col-6 freelancerBox"
                   v-for="(user,index) in businessUsers"
                   v-bind:key="index">
                <div class="freelancerItem">
                  <img :src="getImageSrc(user.image)"
                                         alt="freelancer" class="slickFreelancerImg" style="background:white">
            ...
            <div class="modal-footer"
              ...
              <button class="btn btn-primary"
                      @click="updateCampMembers">Update</button>
            </div>
          </div>
        </div>
      </div>
