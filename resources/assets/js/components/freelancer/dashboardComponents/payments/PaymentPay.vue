        ...
        <div class="col-6">
          <div class="row justify-content-between align-content-between align-items-center responsive-title">
            <div class="invoice-outstand"
                 style="padding: 7px 16px!important; display: inline; margin-left:0;">outstand</div>
            <div class="export-invoice"><img src="/images/client/payments/export_invoice.png"/></div>
