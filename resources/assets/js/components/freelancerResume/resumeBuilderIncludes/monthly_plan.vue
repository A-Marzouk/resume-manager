<template>
  <div class="plan-container">
    ...
    <div class="plan-details">
      <h3 class="plan-original-price section-title">Was $25
        <img src="/images/resume_builder/delete.svg" alt="delete icon">
      </h3>
      <h4 class="plan-offer"><small>Now Only </small><sup>$</sup>19 <small class="not-bold">(Save 30%)</small></h4>
      <div class="help-text">Per Month $19</div>

      <div class="plan-info">
        <div class="benefit" v-for="(benefit, index) in benefits" :key="index"><img src="/images/resume_builder/check_circle.svg" alt="check circle">{{benefit}}</div>
      </div>
