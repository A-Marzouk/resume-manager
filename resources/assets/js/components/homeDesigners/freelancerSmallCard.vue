                ...
                <div class="hireRow showOnlyOnmd">
                    <div class="payment-details">
                        <div style="color: white;" >
                            <img src="/images/home/monetization.svg" alt=""><span class="payment-highLight" style="font-weight: bold;"> $ {{parseInt(freelancer.user_data.salary)}}
                            </span>hourly rate
                        </div>
                        <div style="color: white;">
                  ...
                  <div class="modal-body contact_pop_up">
                      <div class="d-flex justify-content-between">
                          <div class="title d-flex justify-content-center">
                              Send {{freelancer.firstName}} a message <img src="/images/home/emoji.png"
...
export default {
    ...
    methods:{
        ...
        setResizedImagesList(){
            ...
            $.each(projects, (i) =>{
                let resizedImage = this.getImageSrc(projects[i].mainImage).replace('/uploads','/uploads/resized-images');
