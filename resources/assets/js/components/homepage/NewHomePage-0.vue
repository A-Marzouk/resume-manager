		...
		<div class="main-conainter-home">
			<div class="conainter-home">
				...
				<div class="search-section">
					<div class="search">
						<v-autocomplete class="searchBar-input" v-model="searchValue" multiple :items="predictions" placeholder="Type here..." @change="searchValueChanged" outlined dense>
							<button slot="append">
								<img src="/images/new_homepage/pen-tool.svg" alt="pen tool" />
							</button>
							<button slot="prepend-inner">
								<img src="/images/new_homepage/magnifiy.svg" alt="pen tool" />
							</button>
						</v-autocomplete>
				...
				<div class="theme-section">
					...
					<div class="theme" v-for="(profile, i) in filteredProfiles" :key="i" v-if="!isSearching" @mouseover="showDetailsIndex = i" @mouseleave="showDetailsIndex = null">
						<a :href="profile.url">
						...
						<div class="view-details" v-if="showDetailsIndex === i">
							...
							<div class="view-portfolio">
								<a target="_blank" :href="profile.url" class="view-portfolio-button">View Portfolio</a>
							</div>
						</div>
					</div>
					<div class="search-not-found" v-if="filteredProfiles.length < 1 && searchValue.length > 0 && !isSearching">
			...
			<div class="footer">
				...
				<div class="follow-us">
					...
					<div class="facebook">
						<img src="/images/new_homepage/facebook.svg" alt="fackbook" class="follow-logo" />
						<div class="follow-number">13.899 like</div>
					</div>
					<div class="instagram">
						<img src="/images/new_homepage/instagram.svg" alt="instagram" class="follow-logo" />
				...
				<div class="contact-us">
					...
					<div class="social-icons">
						<a :href="icon.link" class="social-logo" v-for="(icon, i) in socialIcons" :key="i">
...
export default {
			...
			profiles: [
				{
					...
					skills:
						"User Interface Design ,Design, Web Design, Photoshop, Illustrator,Illustration, UI/UX, GraphicDesignSkills, Aesthetics, .net, sketch, Photoshop",
				...
				},
				{
					...
					skills:
						"Photoshop, design, illustrator,Illustration, user interface design, ui/ux, Aesthetics, Prototyping ",
				...
				},
				{
					...
					address: "Morocco",
					skills:
						"Adaptability, Typography, Illustrator, Prototyping, Web Design, Motion",
				...
				},
				{
					...
					address: "Bangladesh",
					skills:
						"User Interface Design ,Design, Web Design, InDesign, Perceptivity, Photoshop, Illustrator, UI/UX, GraphicDesignSkills, Aesthetics, .net, sketch, Photoshop",
	...
	methods: {
		...
		getCIVProfiles() {
			axios.get("/get-civ-profiles").then((response) => {
		...
		isJobTitleFound(job_title) {
			...
			if (
				searchText.includes(job_title) ||
				job_title.includes(searchText)
			) {
				return true;
			}
		},
