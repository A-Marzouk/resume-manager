			...
			<div class="d-flex align-items-center --mobile-only">
				<div class="form__input-outer">
					<div class="form__keyword-input__wrapper">
						...
						<input id="form__keyword-input" class="form__keyword-input" type="text" v-model="sharedStore.state.keyword" @focus="isSearching=true" @click.stop @keydown="onInputkeyDown" autocomplete="off" placeholder="Search Freelance Designers for Hire">
						...
						<div v-if="false" class="form__inline-filters">
