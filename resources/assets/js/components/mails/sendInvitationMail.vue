<template>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-check">
                    <input type="checkbox"  class="form-check-input" value="developers" v-model="invitationData.mailingLists"> Developers<br/>
                    <input type="checkbox"  class="form-check-input" value="designers" v-model="invitationData.mailingLists"> Designers<br/>
                    <input type="checkbox"  class="form-check-input" value="business_support" v-model="invitationData.mailingLists"> Business support<br/>
                    <input type="checkbox" class="form-check-input"  value="all" v-model="invitationData.mailingLists"> All freelancers<br/>
                </div>
                <br/>
            </div>
        </div>
            ...
            <div class="col-12">
                ...
                <form action="" method="post" @submit.prevent="addEmail">
                    <div class="form-group">
                        <input type="text" placeholder="Add email" class="form-control" id="email_address"
                               name="email_address"
                               v-model="currEmail"
                               required
        ...
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-primary" id="sendInv" @click="invite">Send invitation</button>
            </div>
        </div>
    </div>
</template>
