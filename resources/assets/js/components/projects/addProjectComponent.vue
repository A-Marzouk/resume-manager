          ...
          <div class="modal-body"
            ...
            <div class="row">
              <div class="col-md-8"
                   ...
                   v-show="!toBeEditedProject.mainImage">
              </div>
              <div class="col-md-8"
                   v-show="toBeEditedProject.mainImage">
                ...
                <div class="col-md-4">
                  <form action="/freelancer/addproject/"
                        method="post"
                        @submit.prevent="submitProjectForm">
                    <div class="row">
                      <div class="form-group col-md-12">
                        <label for="projectName"
                               class="panelFormLabel">Name :</label>
                        <input type="text"
                               class="form-control"
                               id="projectName"
                               name="projectName"
                               v-model="toBeEditedProject.projectName"
                               required>
                      </div>
                      <div class="form-group col-md-12">
                        <label for="link"
                               class="panelFormLabel">Link:</label>
                        <input type="text"
                               class="form-control"
                               id="link"
                               name="link"
                               v-model="toBeEditedProject.link">
                      </div>
                      <div class="form-group col-md-12">
                        <label for="projectDesc"
                               class="panelFormLabel">Description :</label>
                        <textarea class="form-control"
                                  rows="3"
                                  id="projectDesc"
                                  name="projectDesc"
                                  v-model="toBeEditedProject.projectDesc">
                                            </textarea>
                      </div>
                      <div class="form-group col-md-12">
                        <label for="order"
                               class="panelFormLabel">Choose project order
                        </label>
                        <select class="custom-select"
                                style="@if($errors->has('jobTitle')) border:1px solid red; @endif padding-top: 12px !important; padding-bottom: 12px !important; height: auto!important;"
                                id="order"
                                name="order"
                                v-model="toBeEditedProject.order">
                          <option :value="index"
                                  v-for="index in 8"
                                  :key="index"
                                  :selected="index === toBeEditedProject.order">{{index}}</option>
                        </select>
                      </div>
                      <div class="form-group col-md-12">
                        <div class="custom-file"
                          ...
                          <input type="file"
                                 id="mainImage"
                                 ref="file"
                                 class="custom-file-input panelFormInput"
                                 name="mainImage"
                                 @change="handleFile"
                                 accept="image/*">
                      ...
                      <div class="form-group col-md-12"
                           style="opacity: 0; height: 0.1px !important; width:0.1px; !important">
                        <div class="custom-file"
                             style="padding-top: 5px;">
                          <input type="file"
                                 id="newImage"
                      ...
                      <div class="form-group col-md-12">
                        <label class="form-check-label checkBoxText checkBoxContainer">
                          <input id="isActive"
                                 ...
                                 style="@if($errors->has('design_skills_checkbox')) border:1px solid red; @endif"
                                 type="checkbox"
                                 name="isActive"
                                 :checked="toBeEditedProject.isActive"
                                 v-model="toBeEditedProject.isActive">
                          Active
                      ...
                      <div class="text-left noHoverEffect">
                        <a class="btn btn-default btn-workExp" id="addProjectText"  @click="openNewImageBrowse">
                                                <span>
                                                    <img src="/images/add_work_img.png" alt="add project"
                                                         width="30px">
                                                    Add image
                                                </span>
                                            </a>
                      ...
                      <div class="row text-right">
                        <div class="col-md-6"
                             v-for="(image,index) in toBeEditedProject.images"
                             v-show="image !== '' "
