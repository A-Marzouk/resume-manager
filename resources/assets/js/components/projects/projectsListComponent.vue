<template>
  <div>
    <transition-group name="list"
      ...
      <project-detail v-for="(project,index) in projects"
        ...
        <button type="button"
                ...
                class="close"
                style="padding:3px 2px 5px 0px; outline: none;"
                @click="editProject(project.id)">
          <span aria-hidden="true">
                    <img src="/images/edit.png" alt="edit" width="17px">
                </span>
        </button>
    ...
    <br />
    <add-project-modal @projectAdded="addProject"
                       :toBeEditedProject="toBeEditedProject"></add-project-modal>
  </div>
</template>
<script>
export default {
