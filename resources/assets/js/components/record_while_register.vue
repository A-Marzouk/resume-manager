<template>
  <div :class="{loader : isLoading}"
       id="loaderArea">
    <form action="/freelancer/workforce/register_business"
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="business_firstName"
                   class="panelFormLabel">First name *</label>
            <input id="business_firstName"
                   type="text"
                   class="panelFormInput form-control"
                   name="firstName"
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="business_lastName"
                   class="panelFormLabel">Last name *</label>
            <input id="business_lastName"
                   type="text"
                   class="panelFormInput form-control "
                   name="lastName"
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="business_email"
                   class="panelFormLabel">Email *</label>
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="business_phone"
                   class="panelFormLabel">Phone *</label>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label for="business_whatsapp"
                   class="panelFormLabel">Whatsapp</label>
            <input id="business_whatsapp"
                   type="text"
                   class="panelFormInput form-control"
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="business_skype"
                   class="panelFormLabel">Skype</label>
            <input id="business_skype"
                   type="text"
                   class="panelFormInput form-control"
                   v-model="freelancerData.skype"
                   name="skype">
            <span style="width:100%;margin-top:.25rem;font-size:80%;color:#dc3545">
