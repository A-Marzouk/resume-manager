                    ...
                    <div class="modal-body">
                        <form action="/freelancer/addrecord/"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12  d-flex flex-column align-items-start">
                                ...
                                <div class="form-group col-md-12  d-flex flex-column align-items-start"
                                    ...
                                    <div class="d-flex justify-content-between w-100">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-success btn-sm "
                                           @click="setUploadMethod('url')">GDrive URL</a>
                                ...
                                <div id="recordAudio"
                                    ...
                                    <div class="recorder_wrapper">
                                        <div class="recorder">
                                            ...
                                            <div class="NoDecor">
                                                <a href="javascript:void(0)" id="startRecord" class="btn btn-default">New
                                                    record</a>
                                                <a href="javascript:void(0)" id="stopAudio" style="padding-top: 20px;"
                                                   class="d-none">Stop</a>
                                                <br>
                                                <a href="javascript:void(0)" id="playAudio" class="d-none">Play</a><br/>
                                                <a href="javascript:void(0)" id="downloadAudio"
                                                   class="d-none">Download</a><br/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div id="urlToAudio"
                                     class="form-group col-md-12 d-flex flex-column align-items-start"
                            ...
                            <div class="modal-footer">
                                <a href="javascript:void(0)" class="btn btn-success" @click="clearUploadMethod"
                                   v-show="uploadMethod.length > 0"> Back </a>
                                <button type="submit"
                                        class="btn btn-success"
                                        v-show="uploadMethod != 'record'"
                                        v-bind:disabled="toBeEditedRecord.src.length < 1 && !fileChosen">Save
                                </button>
                                <!-- submit button for records -->
                                <a class="btn btn-success d-none" id="saveAudio" @click="loadingBtn"
                                   style="color: white!important;" v-show="uploadMethod == 'record'">Save</a>
                                <button disabled
                                        id="loadingBtn"
                                        class="d-none btn btn-success">Uploading..
                                </button>
                            </div>
                        </form>
                    </div>
