<template>
    <div>
        <transition-group name="list" class="row">
            <reference-component v-for="(reference,index) in references" v-bind:key="Math.random()" class="list-item workExperience col-12" style="margin: 0px 10px 20px;">
                ...
                <span class="deleteWorkBtn NoDecor"  @click="editReference(reference.id)" style=" width: 75px; margin-right:5px;">
    ...
    height: 15px;">
        ...
        <br/>
        <add-reference-modal @referenceAdded="addReference" :toBeEditedReference="toBeEditedReference"></add-reference-modal>
    </div>
</template>
