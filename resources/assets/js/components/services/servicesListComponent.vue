<template>
  <div>
    ...
    <transition-group name="list"
                      class="row">
      <service-component v-for="(service,index) in services"
                         v-bind:key="index"
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div v-if="service.agents !== undefined">
              Agents :
              <div v-for="(agent,index) in service.agents"
                   v-bind:key="index"
                   style="font-size: 16px;color: #30323D;font-family: Roboto;line-height: 19px;font-weight: bold; ">
            ...
            <label class="col-md-5 form-check-label checkBoxContainer checkBoxText"
                   v-show="service.invoice_id === null"
            ...
            <div v-show="service.invoice_id !== null "
                 style="color: blue; padding-top:15px;">
    ...
    <br />
    <add-invoice-service-modal @serviceAdded="addService"
                               :toBeEditedService="toBeEditedService"></add-invoice-service-modal>
  </div>
</template>
<script>
export default {
