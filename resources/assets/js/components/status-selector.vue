<template>
  <div class="status-selector-component">
    ...
    >
      ...
      <div class="status-component">
        <a v-on:click="selectedStatus = 'appointment-set'" href="javascript:;"  style="background: #8567FF;" class="icon">AS</a>
        <span class="icon-name">Appointment<br>set</span>
      </div>
      <div class="status-component">
        <a v-on:click="selectedStatus = 'contacts-received'" href="javascript:;"  style="background: #4ABFF1;" class="icon">CR</a>
        <span class="icon-name">Decission<br>maker<br>contacts received</span>
      </div>
      <div class="status-component">
        <a v-on:click="selectedStatus = 'successful'" href="javascript:;"  style="background: #2ABD68;" class="icon">S</a>
