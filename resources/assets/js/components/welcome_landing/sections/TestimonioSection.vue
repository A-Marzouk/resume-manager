<template>
    <div class="row comments-wrap">
        <div class="col-lg-12 col-sm-12 pa-0 top-title">
            <span class="title-two">Resume's our users have created</span>
        </div>
        <div class="col-lg-5 col-sm-12 pa-0 top-resumes hideOnTab">
            <div class="item-top">
...
<style lang="scss">
        ...
        @media screen and (max-width: 769px) {
            ...
            .author-comment {
                ...
                .item-top {
                    ...
                    .profile_picture {
                        &.photo3 {
                            background-image: url('/images/welcome_landing_page/icons/resume-profile3.png');
                        }
                    }
    ...
    .item-top {
        ...
        .profile_picture {
            ...
            width: 105px;
            height: 105px;
            background: url('/images/welcome_landing_page/icons/resume-profile.png') no-repeat;
    ...
    .author-comment {
        ...
        .item-top {
            ...
            .profile_picture {
                min-width: 156px;
                height: 156px;
                background: url('/images/welcome_landing_page/icons/resume-profile2.png') no-repeat;
