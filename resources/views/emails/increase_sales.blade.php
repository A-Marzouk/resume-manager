...
<div class="mailText">
    ...
    <div class="d-flex justify-content-center w-100">
        <video width="100%" height="320px" controls>
            <iframe width="100%" height="320px"
                    src="http://123workforce.magictimeapps.com/videos/sales_video.mp4">
            </iframe>
            <br/>
            <div>
                <a href="http://123workforce.magictimeapps.com/videos/sales_video.mp4" style="text-decoration: none">
                    <img src="http://123workforce.magictimeapps.com/images/sales.png" height="320px" alt="">
                </a>
            </div>
    ...
    <div class="col-md-5 text-center">
        <audio id="audioIntro" controls>
            <source src="http://123workforce.magictimeapps.com/sounds/Cheska-digital (1).mp3" type="audio/ogg">
            <a href="http://123workforce.magictimeapps.com/sounds/Cheska-digital (1).mp3" style="text-decoration: none">
                <img src="http://123workforce.magictimeapps.com/images/audio_bar.png" height="38px" alt="">
            </a>
        </audio>
    </div>
    <br/>
