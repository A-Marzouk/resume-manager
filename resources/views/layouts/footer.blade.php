<div class="customFooter">
    <div class="row container1">
        ...
        <div class="col-md-2 text-center two">
            <div class="footerImg">
                <img src="/images/newResume/logo.png" alt="logo">
            </div>
        </div>
        ...
        <div class="col-md-4 offset-md-7 text-right four">
            <div class="skypeText">
                <a href="skype:live:3cd10e2da1be4354?call">
                    <img src="/images/skypeLogo.png" alt="skype" width="25px" style="opacity: 1;">
            ...
            @if(env('APP_ENV') !== 'local')
                ...
                <div>
                    <a href="https://www.facebook.com/123workforce">
                        <img src="/images/newResume/fb.png" alt="fb" width="25px">
                    </a>
                    <a href="https://www.instagram.com/123workforce/">
                        <img src="/images/newResume/instagram.png" alt="insta" width="25px">
                    </a>
                </div><br/>
