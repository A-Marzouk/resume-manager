...
<div class="businessCardWrapper">
    ...
    <div class="flexrow images">
        <img src="{{public_path().'/images/resume_themes/theme8/workforce.png'}}" alt="" class="social-icon">
        <img src="{{public_path().'/images/resume_themes/theme8/behance (1).png'}}" alt="" class="social-icon">
        <img src="{{public_path().'/images/resume_themes/theme8/dribbble.png'}}" alt="" class="social-icon">
        <img src="{{public_path().'/images/resume_themes/theme8/instagram.png'}}" alt="" class="social-icon">
        <img src="{{public_path().'/images/resume_themes/theme8/XMLID_801_.png'}}" alt="" class="social-icon">
        <img src="{{public_path().'/images/resume_themes/theme8/icon.png'}}" alt="" class="social-icon">
    </div>
