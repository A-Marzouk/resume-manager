<template>
    <div class="container">
        <div class="pageHeading" id="emailsheader" style="padding-bottom:15px; padding-top: 20px;">
            Emails list
        </div>
        <div class="row">
            <div class="col-6">
            ...
            <div class="col-6">
                <div class="form-group">
                    <input type="text" class="form-control panelFormInput"
                           placeholder="Email subject.." style=" background:white" v-model="currEmailSubject">
                </div> <!-- email subject -->
            </div>
        </div>
        <br/>
        ...
        <div class="row">
            <div class="col-6">
                <button @click="sendEmail" class="btn btn-outline-primary" id="sendEmailBtn">Send</button>
            </div>
        </div>

        <!-- modal to view the template review -->
        <!-- Trigger the modal with a button -->
        <button type="button" class="d-none" id="openTemplateModal" data-toggle="modal" data-target="#templateModal"></button>
