                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('client.register.submit') }}">
                        ...
                        <div class="form-group row">
                            <label for="agency" class="col-md-4 col-form-label text-md-right">{{ __('Agency/Business name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address accounts dept') }}</label>
