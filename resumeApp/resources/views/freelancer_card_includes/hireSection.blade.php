<div id="hireContent{{$freelancer->id}}{{$value['id']}}" style="border-top: 1px solid #EBEDEF; ">
    ...
    <div class="row" style="padding-top:50px; padding-bottom: 50px;">
        <div class="offset-md-2 col-12 col-md-8" style="border-top: 1px solid #EBEDEF;">
            <div class="row">
                <div class="col-2 text-left jobTitle" style="font-size: 12px; color: #30323D;">
                    Weekly rate
                </div>
                <div class="col-2 offset-8 text-right jobTitle" style="font-weight: bold;font-size: 12px; color: #30323D;">
    ...
    <div class="row" style="border-top: 1px solid #EBEDEF;">
        <div class="col-md-4 offset-md-2 col-12 NoDecor" style="padding-top: 17px; padding-bottom: 30px;">
