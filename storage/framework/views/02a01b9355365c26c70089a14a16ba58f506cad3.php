<div role="tabpanel" class="panel tab-pane fade" id="attributes">
    ...
    <div class="form-group col-md-12">
        ...
        <div class="form-check">
            <?php $__currentLoopData = $charSkills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="form-check-label col-md-5 checkBoxText checkBoxContainer">
                    <input class="form-check-input" type="checkbox" name="charSkills[]" value="<?php echo e($skill); ?>"
    ...
    <div class="form-group col-md-12">
        <label for="personal_interests" class="panelFormLabel">Outside of work , what are your hobbies and interests?<span id="tickMarkpersonal_interests" class="d-none"><img src="/images/Shape.png" width="15px;" height="12px;"></span></label>
        <textarea class="form-control" rows="3" id="personal_interests" name="personal_interests"><?php echo e($personal_interests); ?></textarea>
    </div> <!-- interests -->
    ...
    <div class="form-group col-md-12">
        <label for="professional_attributes" class="panelFormLabel">Please talk in greater detail about your character skills and personal attributes that you have ticked above or other character skills you have.
            <span id="tickMarkprofessional_attributes" class="d-none"><img src="/images/Shape.png" width="15px;" height="12px;"></span></label>
        <textarea class="form-control" rows="3" id="professional_attributes" name="professional_attributes"><?php echo e($professional_attributes); ?></textarea>
    </div> <!-- attributes -->
