...
<div class="portfolioRow" id="tapsArea<?php echo e($freelancer->id); ?><?php echo e($value['id']); ?>">
    ...
    <?php else: ?>
        ...
        <div id="portfolioContent<?php echo e($freelancer->id); ?><?php echo e($value['id']); ?>_mob">
    <div class="showOnlyOnsm">
        
        <div id="portfolioCarousel<?php echo e($freelancer->id); ?><?php echo e($value['id']); ?>_mob" class="carousel slide" data-ride="carousel"
             data-interval="false">
            <div class="slickSlide_portfolio" style="background: #fdfdfd;">
                <?php if(!empty($workExamples)): ?>
                    <? $i=1;?>
                    <?php $__currentLoopData = $workExamples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workExample): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row">
                            <div class="col-12">
                                <div class="workCard" style="margin-left: 0">
                                    <div class="workImg">
