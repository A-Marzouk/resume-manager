<div class="col-md-2">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <?php endif; ?>
        <?php if(in_array('Campaigns',$permissions)): ?>
            <li class="col-md-12">
                <a class="btn btn-block btn-outline-primary" href="<?php echo e(route('view.campaigns')); ?>"  style="margin-bottom: 6px;">
                    Campaigns
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if(in_array('Agents',$permissions)): ?>
            <li class="col-md-12">
                <a class="btn btn-block btn-outline-primary" href="<?php echo e(route('view.agents')); ?>"  style="margin-bottom: 6px;">
                    Agents
                </a>
            </li>
        <?php endif; ?>

        <?php if(in_array('Camp Briefs',$permissions)): ?>
            <li class="col-md-12">
                <a class="btn btn-block btn-outline-primary" href="<?php echo e(route('view.cBriefs')); ?>"  style="margin-bottom: 6px;">
                    Camp Briefs
                </a>
            </li>
        <?php endif; ?>
        <?php if(in_array('Bookings',$permissions)): ?>
            <li class="col-md-12">
        ...
        <?php endif; ?>
        <?php if(in_array('Affiliates',$permissions)): ?>
            <li class="col-md-12">
        ...
        <?php endif; ?>
        <?php if(in_array('Public search links',$permissions)): ?>
            <li class="col-md-12">
        ...
        <?php endif; ?>
        <?php if(in_array('Search Freelancers',$permissions)): ?>
            <li class="col-md-12">
        ...
        <?php if(in_array('Send emails',$permissions)): ?>
            <li class="col-md-12">
