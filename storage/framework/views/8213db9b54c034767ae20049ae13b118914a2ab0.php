...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container m-auto infoBar container">
        ...
        <div class="col-md-2 offset-md-10">
            <a target="_blank" href="/v2/<?php echo e($username); ?>">Link to resume </a>
        </div>
        <? endif; ?>
    </div>
        ...
        <div class="freelancerCard" style="margin-bottom: -3px;">
            <div class="row actionRow">
                <div class="importBtn NoDecor">
                    ...
                    <a
                            href="https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=<?php echo e($clientID); ?>&redirect_uri=<?php echo e($redirectURL); ?>&state=987654321&scope=r_liteprofile%20r_emailaddress%20w_member_social"
