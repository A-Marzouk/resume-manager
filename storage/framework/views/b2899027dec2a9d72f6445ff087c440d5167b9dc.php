 ...
 <div role="tabpanel" class="panel tab-pane fade" id="multimedia">
    <div class="panelHeading">
     ...
     <div class="form-group row">
         <div class="col-md-12">
             ...
             <input type="text" class="form-control panelFormInput" id="audio_intro" name="audio"
                    value="https://drive.google.com/file/d/<?php echo e($audio); ?>/view"><br/>
         </div>
     </div>
             ...
             <div class="custom-file" style="padding-top: 5px;">
                 ...
                 <label class="custom-file-label" id="audioLabel" for="">
                     ...
                     if(!empty(trim($audioFile))){
                         $audioSrc = $audioFile;
                         $audioFile = str_replace('uploads/',"",$audioFile);
     ...
     <div class="row">
         <div class="col-md-8">
             <input type="text" class="form-control panelFormInput" id="audioText" value="<?php echo e($audioFile); ?>" disabled style="background: white;">
         </div>
     ...
     <div class="row" style="padding-top: 30px;">
         <div class="col-md-4 offset-md-4">
             <audio id="audioIntro" controls style="padding-bottom: 10px;" preload="auto">
                 <source src="<?php echo e($audioSrc); ?>" id="audioIntroForm">
     ...
     <div class="row">
         <div class="form-group col-md-12">
             ...
             <textarea class="form-control" rows="3" name="audio_transcript" id="audio_transcript"><?php echo e($audio_transcript); ?></textarea>
         </div> <!-- transcript -->
     </div>
     ...
     <? if(session()->get('admin') && session()->get('admin') == 'AdminWasHere'):?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control panelFormInput" id="video" name="video"
                       value="<?php echo e($video); ?>"><br/>
                <div class="text-center col-md-6">
                    <iframe src="<?php echo e($youtubeSrc); ?>" frameborder="0" allow="encrypted-media" allowfullscreen id="videoFrame" width="100%" height="220px"></iframe>
                </div>
            </div>
        </div><br/>
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="custom-file" style="padding-top: 5px;">
                    ...
                    <label class="custom-file-label" id="videoLabel" for="">
                        ...
                        <?
                        $videoSrc = $video_file;
                        $video_file = str_replace('uploads/videos/',"",$video_file);
                        ?>
                        <?php echo e($video_file); ?>
        ...
        <div class="row">
            <div class="col-md-8">
                <input type="text" class="form-control panelFormInput" id="videoText" value="<?php echo e($video_file); ?>" disabled style="background: white;">
            </div>
            <div class="col-md-2 col-6">
            ...
            <div class="col-md-6">
                <div class="text-center">
                    <video width="100%" id="videoFileFrame" height="auto" controls>
                        <source src="<?php echo e($videoSrc); ?>">
                    </video>
                </div>
