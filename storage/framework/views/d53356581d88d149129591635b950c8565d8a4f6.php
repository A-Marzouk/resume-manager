            ...
            <form id="contact-form" method="POST" class="clientForm">
                ...
                <div class="row" style="padding-top:25px;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="checkBoxText form-check-label checkBoxContainer">
                                <input type="checkbox" id="bookkeper" name="bookkeper" <?php echo e(old('remember') ? 'checked' : ''); ?> checked>
                                I need a Designer
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="checkBoxText form-check-label checkBoxContainer">
                                <input type="checkbox" id="accountant" name="accountant"<?php echo e(old('remember') ? 'checked' : ''); ?>>
                                I need a Developer
                                <span class="checkmark"></span>
                            </label>
                        </div>
