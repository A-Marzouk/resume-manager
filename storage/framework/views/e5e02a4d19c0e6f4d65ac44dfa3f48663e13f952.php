        ...
        <div class="row nameRow">
            ...
            >
                    ...
                    <div class="row">
                            ...
                            <div class="hoursBtn NoDecor" style="color:white; background: none; border:none;">
                                <div class="row">
                                    <div class="col-md-2 col-2" style="padding: 9px 0 0 0;">
                                        <a href="javascript:void(0)" id="dollarsMinus<?php echo e($freelancer->id); ?>"
                                           class="dollarsMinus">
                                    ...
                                    <div class="col-md-8 col-8 textBox">
                                        <span id="numberOfDollars<?php echo e($freelancer->id); ?>"><?php echo e($freelancer->userData->salary); ?></span>
                                        $<br/>
                                        <span style="font-size: 13px; font-weight: normal">Hourly Rate</span>
                                    </div>

                                    <div class="col-md-2 col-2" style="padding: 9px 0 0 0;">
                                        <a href="javascript:void(0)" id="dollarsPlus<?php echo e($freelancer->id); ?>"
                                           class="dollarsPlus">
                        ...
                        <div class="text-center hireRow calculateBox" style="margin-left: 7px;">
                            <div class="hoursBtn NoDecor" style="color:white; background: none; border:none;">
                                <div class="row">
                                    <div class="col-md-2 col-2" style="padding: 9px 0 0 0;">
                                        <a href="javascript:void(0)" id="hoursMinus<?php echo e($freelancer->id); ?>"
                                           class="hoursMinus">
                                            <img src="/images/newResume/minus copy 6.png"
                                                 style="width: 18px; padding-right: 8px;" alt="minus">
                                        </a>
                                    ...
                                    <div class="col-md-8 col-8 textBox">
                                        <span id="numberOfHours<?php echo e($freelancer->id); ?>"><?php if($freelancer->userData->availableHours==0): ?>
                                                0 <?php else: ?> <?php echo e($freelancer->userData->availableHours); ?> <?php endif; ?></span>
                                        hours<br/>
                                    ...
                                    <div class="col-md-2 col-2" style="padding: 9px 0 0 0;">
                                        <a href="javascript:void(0)" id="hoursPlus<?php echo e($freelancer->id); ?>"
                                           class="hoursPlus">
                                            <img src="/images/newResume/plus copy 6.png"
                                                 style="width: 18px; padding-left: 8px;" alt="plus">
                                        </a>
                ...
                <input type="file" id="photoInput" name="photo"
                       style="width: 1px; height: 1px; opacity: 0; right:145%;">
                <input type="text" id="salary<?php echo e($freelancer->id); ?>" name="salary"
                       style="width: 1px; height: 1px; opacity: 0; right:145%;" value="<? if (!empty($salary)) {
                    echo $salary;
                } else {
                    echo '';
                }?>">
                <input type="text" id="availableHours<?php echo e($freelancer->id); ?>" name="availableHours"
    ...
    <div id="nav-taps-resume-card">
        <ul class="nav nav-tabs navRow" role="tablist">
            ...
            <li class="offset-md-2 nav-item col-md-2 col-4 NoDecor">
                <a class="nav-link navTab text-center active" href="#skills<?php echo e($freelancer->id); ?>" role="tab" data-toggle="tab">
                    Skills
                </a>
            </li>
            ...
            <?php if($freelancer->profession == 'businessSupport'): ?>
                <li class="col-md-2 col-4 nav-item NoDecor">
                    <a class="nav-link navTab text-center " href="#recordings<?php echo e($freelancer->id); ?>" role="tab"
                       data-toggle="tab">
                        Recordings
                    </a>
                </li>
            <?php else: ?>
                <li class="col-md-2 col-4 nav-item NoDecor">
                    <a class="nav-link navTab text-center " href="#portfolio<?php echo e($freelancer->id); ?>" role="tab"
                       data-toggle="tab">
                        Projects
                    </a>
                </li>
            ...
            <li class="nav-item col-md-2 col-4 NoDecor d-none">
                <a class="nav-link navTab text-center" id="showReferences<?php echo e($freelancer->id); ?>"
                   href="#references<?php echo e($freelancer->id); ?>" role="tab" data-toggle="tab">
                </a>
            </li>

            <li class="nav-item col-md-2 col-4 NoDecor">
                <a class="nav-link navTab text-center" href="#education<?php echo e($freelancer->id); ?>" role="tab"
                   data-toggle="tab">
                    Education
                </a>
            </li>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active firstItem" id="skills<?php echo e($freelancer->id); ?>">
        ...
        <?php if($freelancer->profession == 'businessSupport'): ?>
                <div role="tabpanel" class="tab-pane  firstItem" id="recordings<?php echo e($freelancer->id); ?>">
            ...
            <?php else: ?>
                <div role="tabpanel" class="tab-pane firstItem" id="portfolio<?php echo e($freelancer->id); ?>">
                    <div class="row" style="padding-top:17px; padding-bottom: 16px;background: #fdfdfd;">
                        <div class="col-md-12">
